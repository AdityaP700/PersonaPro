...
export default function TabHead({ title, isActive }) {
  return (
    <div className='flex justify-center items-center relative group'>
      ...
      `{isActive ? (<div class=" absolute w-full h-full inset-0 rounded-lg bg-gradient-to-br from-pink-500 via-cyan-500 to-violet-500 blur group-hover:animate-tilt"></div>):null}`
